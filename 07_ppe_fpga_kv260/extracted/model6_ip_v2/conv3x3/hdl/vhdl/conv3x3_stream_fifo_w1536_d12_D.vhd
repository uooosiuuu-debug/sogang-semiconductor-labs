...
entity conv3x3_stream_fifo_w1536_d12_D is
    generic (
...
architecture arch of conv3x3_stream_fifo_w1536_d12_D is

    -- component
    component conv3x3_stream_fifo_w1536_d12_D_ram is
    generic (
        MEM_STYLE  : string  := "distributed";
        DATA_WIDTH : natural := 1536;
...
begin
----------------------- Instantiation -----------------------
    U_conv3x3_stream_fifo_w1536_d12_D_ram : conv3x3_stream_fifo_w1536_d12_D_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity conv3x3_stream_fifo_w1536_d12_D_ram is
    generic (
        MEM_STYLE   : string  := "distributed";
        DATA_WIDTH  : integer := 1536;
        ADDR_WIDTH  : integer := 4;
...
architecture arch of conv3x3_stream_fifo_w1536_d12_D_ram is
