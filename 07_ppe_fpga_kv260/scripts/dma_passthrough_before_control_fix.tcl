...
################################################################
# This is a generated script based on design: dma_passthrough
#
...
# source dma_passthrough_script.tcl
...
set design_name dma_passthrough
...
xilinx.com:hls:axis_passthrough:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_passthrough_0, and set properties
  set axis_passthrough_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:axis_passthrough:1.0 axis_passthrough_0 ]

  # Create instance: proc_sys_reset_0, and set properties
  set proc_sys_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_0 ]

  # Create instance: reset_const_high, and set properties
  ...
  # Create instance: reset_const_low, and set properties
  ...
  set reset_inverter_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 reset_inverter_0 ]
  set_property -dict [list \
...
\
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_passthrough_0/input_stream]
  ...
  connect_bd_intf_net -intf_net axis_passthrough_0_output_stream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_passthrough_0/output_stream]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins axis_passthrough_0/s_axi_control] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axis_passthrough_0/ap_rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net reset_const_high_dout [get_bd_pins proc_sys_reset_0/dcm_locked] [get_bd_pins reset_const_high/dout]
  connect_bd_net -net reset_const_low_dout [get_bd_pins proc_sys_reset_0/aux_reset_in] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_0/mb_debug_sys_rst] [get_bd_pins reset_const_low/dout]
  connect_bd_net -net reset_inverter_0_Res [get_bd_pins reset_inverter_0/Res]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axis_passthrough_0/ap_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins reset_inverter_0/Op1] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_passthrough_0/s_axi_control/Reg] -force
