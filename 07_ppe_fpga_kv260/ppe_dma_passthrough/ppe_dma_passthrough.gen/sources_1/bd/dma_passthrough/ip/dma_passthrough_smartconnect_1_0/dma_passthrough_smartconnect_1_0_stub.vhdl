...
-- Date        : Fri Jul 31 10:50:52 2026
-- Host        : sogang-500TGA-500SGA running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode synth_stub -rename_top dma_passthrough_smartconnect_1_0 -prefix
--               dma_passthrough_smartconnect_1_0_ dma_passthrough_smartconnect_1_0_stub.vhdl
-- Design      : dma_passthrough_smartconnect_1_0
...
entity dma_passthrough_smartconnect_1_0 is
  Port ( 
    aclk : in STD_LOGIC;
...
end dma_passthrough_smartconnect_1_0;

architecture stub of dma_passthrough_smartconnect_1_0 is
...
attribute X_CORE_INFO of stub : architecture is "bd_e2ba,Vivado 2022.2";
begin
end;
