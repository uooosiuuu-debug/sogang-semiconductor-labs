...
HD_PWD='/home/sogang/ppe_fpga_ho/ppe_dma_passthrough/ppe_dma_passthrough.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_passthrough_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_passthrough_wrapper.tcl
