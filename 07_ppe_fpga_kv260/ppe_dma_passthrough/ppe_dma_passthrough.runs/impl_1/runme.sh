...
HD_PWD='/home/sogang/ppe_fpga_ho/ppe_dma_passthrough/ppe_dma_passthrough.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_passthrough_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dma_passthrough_wrapper.tcl -notrace
